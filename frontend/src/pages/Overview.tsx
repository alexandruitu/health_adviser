    ...
    <div className="flex flex-col gap-6">
      ...
      <AdviserPanel
        ...
        gatherData={useCallback(() => ({
          year,
          heart: { resting_hr_avg: stats.avgRHR, hrv_apple: stats.avgHRVApple, hrv_garmin: stats.avgHRVGarmin },
          sleep: { avg_total: stats.avgSleep, avg_deep: stats.avgDeep, avg_rem: stats.avgREM, avg_core: stats.avgCore },
          body: { weight: stats.latestWeight, avg_weight: stats.avgWeight, body_fat: stats.latestFat, avg_fat: stats.avgFat, vo2max_run: stats.latestVO2, vo2max_cyc: stats.latestVO2Cyc },
          activity: { avg_steps: stats.avgSteps, avg_energy: stats.avgEnergy, sessions: stats.sessions, running_km: stats.runKm, cycling_km: stats.cycKm },
        }), [year, stats])}
      />
